 ...
 @section('content')
         ...
         <div class="container mt-2 text-center">
             ...
             @if (Session::has('total') && Session::get('total') != null)
                 @if (Session::has('order_id') && Session::get('order_id') != null)
                     <h4 style="color:blue; margin-top: 40px" class="my-5">Total: ${{ Session::get('total') }}
                     </h4>
     ...
     <script
          src="https://www.paypal.com/sdk/js?client-id=AbGTVC7MpJAwKQ3yhc2VP7ulTPDsCxqWpKlJnlYJdyQIZjtBr5k-FLQF8ylPTYXgdnNx9BAc4y198MBA&currency=USD">
     </script>
