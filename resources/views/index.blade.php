                ...
                <div class="col-sm-8">
                    <div class="feature">
                        <div class="shack_burger">
                            ...
                            <h2>Shack Burger </h2>
                            <p>Black Angus beef patty topped with American cheese, tomato, lettuce, and “Shack Sauce,”
                                served in a grilled potato bun</p>
                        </div>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="row forth_sec">
                    ...
                    <div class="col-sm-4">
                        <div class="sides">
                            <div class="inner_content">
                                <span class="flaticon flaticon-food" style="margin-left: 0"></span>
                                <h2><a style="color:#fff" href="{{route('category', ['category'=>'breakfast'])}}">break<br>fast</a></h2>
                            </div>
                        </div>
                    </div>
